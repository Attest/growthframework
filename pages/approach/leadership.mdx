...
- Support/train colleagues via the use of pair programming.
...
- Finds way to spread learning across the chapter (gives internal talks, blogs, demos etc).
...
- Facilitates knowledge sharing activities e.g. workshops, lunch and learns.
