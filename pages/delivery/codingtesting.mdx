...
- Defines appropriate testing methodologies when testing modules, services, systems, component.
...
- Drives the overall chapter's testing architecture to test complex flows. Uses non-functional testing tools (for example load testing, pen testing, front end perf testing tools)
